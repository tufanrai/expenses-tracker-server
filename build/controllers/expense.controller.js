...
exports.remove = exports.getAllUserExpByCategory = exports.getExpenseById = exports.getAllByUser = exports.update = exports.create = void 0;
...
exports.getAllByUser = (0, async_handler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const expenses = yield expense_model_1.default.find(Object.assign({ user: userId }, filter))
        .limit(limit)
        .skip(skip)
        .sort({ createdAt: -1 })
        .populate("category");
...
// get expense by id
exports.getExpenseById = (0, async_handler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.getAllUserExpByCategory = (0, async_handler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const expenses = yield expense_model_1.default.find(Object.assign({ user: userId, category: categoryId }, filter))
        .limit(limit)
        .skip(skip)
        .sort({ createdAt: -1 });
